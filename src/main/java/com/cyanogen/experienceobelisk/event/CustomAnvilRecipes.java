...
public class CustomAnvilRecipes {
    ...
    public static void handleCustomRecipes(AnvilUpdateEvent event){
        ...
        if(event.getName() != null && event.getName().length() >= 1){
        ...
        if(right.getItem() instanceof DyeItem || validFormattingItems.contains(right.getItem())){
            ...
            if(validFormattingItems.contains(right.getItem())){
