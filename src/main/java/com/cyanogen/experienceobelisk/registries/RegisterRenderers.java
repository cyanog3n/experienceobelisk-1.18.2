...
import com.cyanogen.experienceobelisk.renderer.ExperienceRelayBlockRenderer;
...
public class RegisterRenderers {
    ...
    public static void registerRenderers(final EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(RegisterBlockEntities.EXPERIENCERELAY_BE.get(), ExperienceRelayBlockRenderer::new);
    }
}
